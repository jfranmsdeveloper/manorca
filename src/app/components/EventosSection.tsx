      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {events.map((event, index) => (
            ...
            >
              <Card className="group overflow-hidden rounded-3xl border border-slate-200 shadow-xl hover:shadow-2xl transition-all h-full flex flex-col hover:border-[#0F172A]">
                {/* Event Image */}
                <div className="relative aspect-[16/10] overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4">
                    <div className="bg-white/95 backdrop-blur-sm rounded-2xl px-4 py-2 shadow-lg">
                      <div className="text-2xl font-bold text-[#0F172A]">{event.daysUntil}</div>
                ...
                <div className="p-6 flex flex-col flex-1">
                  <h3 className="text-xl font-bold text-[#0F172A] mb-4 group-hover:text-blue-600 transition-colors line-clamp-2">
                    {event.title}
                  </h3>
                  ...
                  <div className="space-y-3 mb-4 flex-1">
                    ...
                    <div className="flex items-center gap-3 text-sm text-slate-500">
                      <Clock className="w-4 h-4 text-[#0F172A] flex-shrink-0" />
                      <span>{event.time}</span>
                    </div>
                    <div className="flex items-center gap-3 text-sm text-slate-500">
                      <MapPin className="w-4 h-4 text-[#0F172A] flex-shrink-0" />
                  ...
                  {/* CTA Button */}
                  <Button
                    className="w-full bg-[#0F172A] hover:bg-slate-800 text-white rounded-xl group/btn"
