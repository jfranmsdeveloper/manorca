...
import { BookOpen, Star, Eye, Download, Bookmark, ExternalLink, Image as ImageIcon, ArrowRight, PenTool, Sparkles } from 'lucide-react';
            ...
            <div className="container mx-auto px-4 lg:px-8">
                ...
                <Tabs defaultValue="propias" className="max-w-7xl mx-auto">
                    <div className="flex justify-center mb-16">
                        <TabsList className="grid w-full max-w-3xl grid-cols-3 bg-slate-200/50 dark:bg-slate-900/50 backdrop-blur-xl border border-white/20 dark:border-slate-700/30 p-2 rounded-full shadow-[0_8px_32px_rgba(0,0,0,0.1)]">
                            <TabsTrigger
                                value="propias"
                                className="rounded-full py-4 text-sm lg:text-base font-medium transition-all duration-300 data-[state=active]:bg-gradient-to-r data-[state=active]:from-[#0F172A] data-[state=active]:to-[#334155] data-[state=active]:text-white data-[state=active]:shadow-[0_4px_20px_rgba(15,23,42,0.4)] hover:bg-white/40 dark:hover:bg-slate-800/40"
                            >
                                <PenTool className="w-4 h-4 mr-2 mb-0.5 inline-block" />
                            ...
                            <TabsTrigger
                                ...
                                className="rounded-full py-4 text-sm lg:text-base font-medium transition-all duration-300 data-[state=active]:bg-gradient-to-r data-[state=active]:from-[#0F172A] data-[state=active]:to-[#334155] data-[state=active]:text-white data-[state=active]:shadow-[0_4px_20px_rgba(15,23,42,0.4)] hover:bg-white/40 dark:hover:bg-slate-800/40"
                            >
                                <Sparkles className="w-4 h-4 mr-2 mb-0.5 inline-block" />
                                Recomendadas
                            </TabsTrigger>
                            <TabsTrigger
                                value="galeria"
                                className="rounded-full py-4 text-sm lg:text-base font-medium transition-all duration-300 data-[state=active]:bg-gradient-to-r data-[state=active]:from-[#0F172A] data-[state=active]:to-[#334155] data-[state=active]:text-white data-[state=active]:shadow-[0_4px_20px_rgba(15,23,42,0.4)] hover:bg-white/40 dark:hover:bg-slate-800/40"
                            >
                                <ImageIcon className="w-4 h-4 mr-2 mb-0.5 inline-block" />
                                Galería Plus
                            </TabsTrigger>
                        </TabsList>
                    </div>
